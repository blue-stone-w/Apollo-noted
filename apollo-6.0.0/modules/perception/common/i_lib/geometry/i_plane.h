...
// Fit a plane pi (ax+by+cz+d = 0): in 3D space using// total least square method (Orthogonal Distance Regression).
// The input n 3D points are in  inhomogeneous coordinates. Array X has Size n * 3 and points are stored as
// [x0,y0, z0, x1, y1, z1, ...].
// pi is stored as 4 - vector[a, b, c, d]. x will be destroyed after calling this routine.
template <typename T>
